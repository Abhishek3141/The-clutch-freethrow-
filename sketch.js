...
function draw(){
    ...
    text(" Drag the ball back to shoot. You make it, you win the NBA championship", 0, 200)
    rect(900,350,30,30)
...
if(gamestate == 'Make'){
    ...
    textSize(25)
    text("Lakers  :  131", 210,885)
    text("Cavaliers  : 132 ", 210,950)
    text("Good job, you just won the nba championship. What a clutch freethrow!!!", 150, 400)
    rect(900,350,30,30)
